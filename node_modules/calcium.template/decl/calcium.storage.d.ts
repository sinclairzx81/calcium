declare module calcium.storage.util {
    class path {
        ...
        static join(filepaths: any): string;
        static tokenize(filepath: string): any;
        static basename(filepath: string): string;
        static parent(filepath: string): string;
        static trimbase(filepath: string): string;
        static removebasepath(basepath: string, filepath: string): string;
        static isurl(filepath: string): boolean;
        static isurn(filepath: string): boolean;
...
declare module calcium.storage.ftp {
    class Storage implements storage.Storage {
        ...
        private readStorageObjects(path, data);
        private readStorageObject(path, line);
    }
}
...
declare module calcium.storage.mount {
    class Storage implements storage.Storage {
        private devices;
        constructor();
        public push(logicalName: string, device: storage.Storage): void;
        public exists(path: string, callback: (exists: boolean) => void): void;
        public createfolder(path: string, callback: (success: boolean) => void): void;
        public delete(path: string, callback: (success: boolean) => void): void;
        public readfolder(path: string, callback: (objects: any) => void): void;
