...
module calcium.web 
{
    export class Router 
	{
		...
		public get(path:string,  callback:(app:calcium.web.Context) => void) : void 
        {
			this.routes.push(new calcium.web.Route(path, "GET", callback));
		}

		public post(path:string,  callback:(app:calcium.web.Context) => void) : void 
        {
			this.routes.push(new calcium.web.Route(path, "POST", callback));
		}

		public put(path:string,  callback:(app:calcium.web.Context) => void) : void 
        {
			this.routes.push(new calcium.web.Route(path, "PUT", callback));
		}

		public delete(path:string,  callback:(app:calcium.web.Context) => void) : void 
        {
			this.routes.push(new calcium.web.Route(path, "DELETE", callback));
		}

		public options(path:string,  callback:(app:calcium.web.Context) => void) : void 
        {
