...
@section scripts() {
    ...
    <script type="text/javascript" src="/static/script/bootstrap/js/bootstrap-contextmenu.js"></script>
...
@section sidebar() {
    ...
    <!-- StorageModel Template -->
     ...
     <script type="text/html" id="template.storage">
        ...
        <div data-bind="if: loading">
            ...
            <a href="#" data-bind="click: toggle"><img class='icon-space' src="/static/script/calcium/assets/preloader.gif" /><i class="icon-folder-open"></i><span data-bind="text:name"></span></a>     

            <!-- /ko -->

            <!-- ko ifnot: expanded() -->

            <a href="#" data-bind="click: toggle"><img class='icon-space' src="/static/script/calcium/assets/preloader.gif" /><i class="icon-folder-close"></i><span data-bind="text:name"></span></a>     
    ...
    <script type="text/html" id="template.file">
        ...
        <a href="#" data-toggle="context" data-target="#context-menu" data-bind="click: load"><img class='icon-space' src="/static/script/calcium/assets/preloader.gif" /><i class="icon-file"></i><span data-bind="text:name"></span></a>
