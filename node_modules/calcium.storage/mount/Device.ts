...
module calcium.storage.mount
{
    ...
    {
        private devices:calcium.storage.IDevice[];
        ...
        public push                 (logicalName:string, device : calcium.storage.IDevice) : void
        {
        ...
        public readfolder           (path:string, callback:{ ( objects : calcium.storage.DeviceObject[] ):void; } ): void  
        {
            ...
            if(path.trim() === "/") 
            {
                var result:calcium.storage.DeviceObject[] = [];

                for(var n in this.devices)
                {
                    var storage_object = new DeviceObject();
        ...
        private GetDevice(path:string) : calcium.storage.IDevice {
