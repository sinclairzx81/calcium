    ...
    (function (storage) {
        (function (util) {
            var path = (function () {
                ...
                path.tokenize = function (filepath) {
                ...
                path.trimbase = function (filepath) {
                    var tokens = calcium.storage.util.path.tokenize(filepath);
                ...
                path.removebasepath = function (basepath, filepath) {
...
(function (calcium) {
    (function (storage) {
        ...
        storage.StorageObject = StorageObject;
    })(calcium.storage || (calcium.storage = {}));
    var storage = calcium.storage;
})(calcium || (calcium = {}));
var calcium;
    ...
    (function (storage) {
        (function (ftp) {
            var Storage = (function () {
                function Storage(connection, logger) {
                ...
                Storage.prototype.exists = function (path, callback) {
                    ...
                    var filename = calcium.storage.util.path.basename(device_path);
                ...
                Storage.prototype.createfolder = function (path, callback) {
                    var device_path = calcium.storage.util.path.join([this.connection.basepath, path]);

                    var parent_path = calcium.storage.util.path.parent(device_path);

                    var foldername = calcium.storage.util.path.basename(device_path);
                ...
                Storage.prototype.delete = function (path, callback) {
                    var device_path = calcium.storage.util.path.join([this.connection.basepath, path]);

                    var parent_path = calcium.storage.util.path.parent(device_path);

                    var name = calcium.storage.util.path.basename(device_path);
                ...
                Storage.prototype.readfolder = function (path, callback) {
                    var _this = this;
                    var device_path = calcium.storage.util.path.join([this.connection.basepath, path]);
                                        ...
                                        client.command("LIST", function (response) {
                                            client.wait(function (response) {
                                                _this.getstreamdata(stream, function (data) {
                                                    ...
                                                    client.disconnect(function () {
                                                        var device_objects = _this.readStorageObjects(path, data);
                ...
                Storage.prototype.readstream = function (path, callback) {
                    var device_path = calcium.storage.util.path.join([this.connection.basepath, path]);
                ...
                Storage.prototype.writestream = function (path, callback) {
                    var device_path = calcium.storage.util.path.join([this.connection.basepath, path]);
                ...
                Storage.prototype.getclient = function () {
                ...
                Storage.prototype.getstreamdata = function (stream, callback) {
                    var buffer = [];
                ...
                Storage.prototype.readStorageObjects = function (path, data) {
                    var accumulator = [];
                    ...
                    for (var n in lines) {
                        ...
                        var obj = this.readStorageObject(path, line);
                ...
                Storage.prototype.readStorageObject = function (path, line) {
                    ...
                    if (split.length == 4) {
                        if (line.indexOf("<DIR>") != -1) {
                            ...
                            device_object.name = calcium.storage.util.path.basename(device_object.fullpath);
    ...
    (function (storage) {
        (function (mount) {
            var Storage = (function () {
                ...
                Storage.prototype.push = function (logicalName, device) {
                ...
                Storage.prototype.readfolder = function (path, callback) {
                    if (path.trim() === "/") {
                        ...
                        for (var n in this.devices) {
                            var storage_object = new storage.StorageObject();

                            storage_object.type = "storage";
                ...
                Storage.prototype.GetDevicePath = function (path) {
                    return calcium.storage.util.path.trimbase(path);
                };

                Storage.prototype.GetDevice = function (path) {
                    var tokens = calcium.storage.util.path.tokenize(path);
    ...
    (function (storage) {
        (function (amazon) {
            var Storage = (function () {
                ...
                Storage.prototype.convert_folder_path = function (path) {
                ...
                Storage.prototype.convert_file_path = function (path) {
                    if (path == null || path.length == 0) {
                        return '';
                    }
