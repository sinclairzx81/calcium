...
{   
    export class Storage implements calcium.storage.Storage
    {
                                ...
                                { 
                                      ...
                                      { 
                                          this.getstreamdata(stream, (data) => 
                                          {
                                                ...
                                                client.disconnect(()=>
                                                {
                                                    var device_objects = this.readStorageObjects( path, data );
        ...
        private readStorageObjects(path:string, data:string) : calcium.storage.StorageObject [] {
        ...
        private readStorageObject(path:string, line:string) : calcium.storage.StorageObject 
        {
